...
{
    "name": "Responsive Backend Theme - Cyan",
    "summary": "Odoo 10.0 Community Backend Theme Cyan Color",
    "version": "10.0.1.0.0",
    "category": "Themes/Backend",
    "website": "https://me.repodevs.com",
	"description": """
        Backend theme for Odoo 10.0 Community Edition (based on Openworx Theme). More polished to match the cyan color.
